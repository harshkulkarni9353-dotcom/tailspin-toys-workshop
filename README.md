...
Coding conventions for comments, TSDoc, reusable Astro component props, and TypeScript formatting are documented in the [coding standards instructions](.github/instructions/coding-standards.instructions.md). Exported data-layer functions must document their purpose, parameters, and return values; comments should explain intent rather than restate code.
